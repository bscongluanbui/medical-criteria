...
def main():
    ...
    values.update(APP_VERSION="local", API_PORT="8001", DASHBOARD_PORT="3500", DASHBOARD_ORIGIN="https://criteria.bcanatomy.site", CRITERIA_ROOT="/home/ubuntu/criteria", MEDICAL_LIBRARY_ROOT="/home/ubuntu/rclone/papers")
    try:
